...
export function _saveQuestionAnswer({ authedUser, questionId, answerText }) {
  return new Promise((res, rej) => {
    setTimeout(() => {
      users = {
        ...users,
      ...
      questions = {
        ...
        [questionId]: {
          ...
          [answerText]: {
            ...questions[questionId][answerText],
            votes: questions[questionId][answerText].votes.concat([authedUser]),
          },
        },
      };
